...
class WrongNumberCaseTest extends TestCase
{
    /** @test */
    public function it_creates_an_shipment_and_make_it_wrong_number_and_do_the_required_operations()
    {
        ...
        $exceptionResponse = $this->withHeaders($headers)
            ->postJson(
                ...
                [
                    'tracking_no'     => $shipment->tracking_no,
                    'delivery_exception' => 'WRONG_NUMBER',
                ]
            );
        ...
        // Call the shelf shipments endpoint via GET
        ...
        $tasks = collect($shelfShipmentsResp->json('data.data'))
            ->pluck('id');
