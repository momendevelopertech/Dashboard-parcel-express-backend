...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ShipmentInformation>
 */
class ShipmentInformationFactory extends Factory
{
    /**
    ...
    {
        return [
            // 'package_id'  => Package::inRandomShipment()->first()->id,
